...
solar_instantaneous_results <- data.frame(
  Model = c("Lasso 50 MW", "Lasso 100 MW", "Lasso 200 MW"),
  ATET = c(solar_instantaneous_did50lasso$ATET, 
           solar_instantaneous_did100lasso$ATET, 
           solar_instantaneous_did200lasso$ATET),
  SE = c(solar_instantaneous_did50lasso$se, 
         solar_instantaneous_did100lasso$se, 
         solar_instantaneous_did200lasso$se),
  P_Value = c(solar_instantaneous_did50lasso$pval, 
              solar_instantaneous_did100lasso$pval, 
...
gas_instantaneous_results <- data.frame(
  Model = c("Lasso 50 MW", "Lasso 100 MW", "Lasso 200 MW"),
  ATET = c(gas_instantaneous_did50lasso$ATET, 
           gas_instantaneous_did100lasso$ATET, 
           gas_instantaneous_did200lasso$ATET),
  SE = c(gas_instantaneous_did50lasso$se, 
         gas_instantaneous_did100lasso$se, 
         gas_instantaneous_did200lasso$se),
  P_Value = c(gas_instantaneous_did50lasso$pval, 
              gas_instantaneous_did100lasso$pval, 
...
wind_one_year_post_results <- data.frame(
  Model = c("Lasso 50 MW", "Lasso 100 MW", "Lasso 200 MW"),
  ATET = c(wind_one_year_post_did50lasso$ATET, 
           wind_one_year_post_did100lasso$ATET, 
           wind_one_year_post_did200lasso$ATET),
  SE = c(wind_one_year_post_did50lasso$se, 
         wind_one_year_post_did100lasso$se, 
         wind_one_year_post_did200lasso$se),
  P_Value = c(wind_one_year_post_did50lasso$pval, 
              wind_one_year_post_did100lasso$pval, 
